...
var ArrayStorage =/*#__PURE__*/function () {// Un constructeur pour initialiser l'objet avec le nom de la clé et son contenu (valeur)
    ...
    return _createClass(a, [{
        key: "get", value: function get() { return localStorage.getItem(this.name) || localStorage.setItem(this.name, "[]"), JSON.parse(localStorage.getItem(this.name)) }// Une méthode pour ajouter une valeur dans le tableau
    }, {
